...
The filament I use was sponsored by my friend [itsmeyaboi-debug](https://github.com/itsmeyaboi-debug). It have aged during storage and kept in an open space at room temperature(around 22C) for an extended period, which may have affected its condition. Before printing, it was dried at **65°C for 8 hours** to reduce moisture-related issues.
